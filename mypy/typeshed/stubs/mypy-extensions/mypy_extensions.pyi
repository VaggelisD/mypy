...
class char:
    ...
    # Codepoint-as-int ops: char stored as int32 can be used as a list index
    # (via __index__) and compared against int literals (e.g. ``0 <= c < 128``).
    # Empty sentinel reports as -1.
    def __index__(self) -> int: ...
    ...
    # Case conversion. ASCII fast path; non-ASCII delegates to the str
    # method. Returns the original codepoint if the result is multi-char
    # (e.g. ß.upper() = "SS") since char holds one codepoint.
    def upper(self) -> char: ...
    def lower(self) -> char: ...
